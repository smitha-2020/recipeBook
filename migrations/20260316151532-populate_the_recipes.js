...
export const up = async (db, client) => {
  ...
  await db.collection("recipes").insertMany([
    ...
    },
    {
      ...
      categorySnapshot: [
        categories[1],categories[4],categories[9],
      ],
